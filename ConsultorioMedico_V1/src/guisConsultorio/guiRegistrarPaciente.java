...
public class guiRegistrarPaciente extends JFrame implements ActionListener{
	...
	//inici variables panel jpDatos Paciente
	public static JLabel jlbCi,jlbNroHistClinica,jlbApellido1,jlbApellido2,jlbNombre1,jlbNombre2,jlbTelefono,jlbDireccion,jlbSexo,jlbProvincia,jlbCanton,jlbParroquia,jlbLugarResidencia,jlbFechaNac;
	public static JTextField jtfCi,jtfNroHistClinica,jtfApellido1,jtfApellido2,jtfNombre1,jtfNombre2,jtfTelefono,jtfDireccion,jtfFechaNac;
	public static JRadioButton jroMasculino,jroFemenino;
	public static ButtonGroup jroGrSexo;
	...
	public void datospaciente()
	{
		...
		jlbTelefono=new JLabel("Telefono ");jtfTelefono=new JTextField(20);
		...
		//septima fila 
		gbc.gridwidth=1;
		jpDatosPaciente.add(jlbTelefono,gbc);
		gbc.gridwidth=GridBagConstraints.REMAINDER;
		jpDatosPaciente.add(jtfTelefono,gbc);
		//octava fila
		gbc.gridwidth=1;
		...
		objGestionGui.sNumeros(jtfTelefono, 10);
	...
	public void datospaciente2()
	{
		...
		jroGrSexo=new ButtonGroup();
		jroGrSexo.add(jroFemenino);jroGrSexo.add(jroMasculino);
		...
		jtbTablaDespliegue.addMouseListener(new MouseAdapter() 
		{
			public void mousePressed(MouseEvent e)
			{
				...
				if (e.getClickCount() == 2) 
				{
					...
					jtfTelefono.setText(jtbTablaDespliegue.getValueAt(row, 11).toString());
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		{//inicio boton grabar
			...
			if(jtfTelefono.getText().length()==9||jtfTelefono.getText().length()==10)
			{
				objRegistPac.setStrTelefono(jtfTelefono.getText());
			}
			else
			{
				if(jtfTelefono.getText().length()<9&&jtfTelefono.getText().length()>0)
				{
