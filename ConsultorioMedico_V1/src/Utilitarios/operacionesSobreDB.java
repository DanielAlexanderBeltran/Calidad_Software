...
public class operacionesSobreDB {
	...
	public String[] obtnerColumNames(String strTblName)
	{
		...
		try 
		{
			...
			ResultSet rs = metaDatos.getColumns("prg2consultorios", null, strTblName, null);
	...
	public void insertarDatosDB(String strTblName,String strArrColsNames[], String strArrValues[])
	{
