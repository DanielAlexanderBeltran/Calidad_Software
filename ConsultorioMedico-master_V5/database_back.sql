...
INSERT INTO `dia_medico` VALUES (6,2,'L',1),(7,3,'L',1),(8,3,'M',1),(9,3,'X',1),(10,3,'J',1),(11,3,'V',1),(12,3,'S',1),(13,3,'D',1),(14,4,'L',1),(15,4,'M',1);
...
INSERT INTO `especialidad` VALUES (2,'PROCTOLOGIA','ASD FG F  D FG HFG F',1),(3,'Cardiologia','Estudio del sistema Cardiovascular',1);
...
INSERT INTO `hora_medico` VALUES (6,6,'8:00 A.M','10:00 A.M',1),(7,7,'8:00 A.M','4:00 P.M',1),(8,8,'8:00 A.M','4:00 P.M',1),(9,9,'8:00 A.M','4:00 P.M',1),(10,10,'8:00 A.M','4:00 P.M',1),(11,11,'8:00 A.M','4:00 P.M',1),(12,12,'8:00 A.M','5:00 P.M',1),(13,13,'8:00 A.M','4:00 P.M',1),(14,14,'8:00 A.M','4:00 P.M',1),(15,15,'8:00 A.M','1:00 P.M',1);
...
INSERT INTO `medico` VALUES (2,'PERICO','DE LOS PALOTES',2,5,1,''),(3,'Leonardo Francisco','Venegas',3,6,1,''),(4,'Juan','Pablo',2,7,1,'cedula');
...
INSERT INTO `paciente` VALUES (2,'perico paciente','de los palotes',23,1.23,23,'0996-8875','ninguna','infarto','O+',1,'jose@mail.com','M','1720192523','la chingada'),(3,'perico paciente','de los palotes',23,2,18,'0996-8875','ninguna','infarto','O+',1,'jose@mail.com','M','1720192523','la chingada'),(4,'Daniel','Beltran',150,1.7,28,'2655-4189','Ninguna','hipertension','A+',1,'litomh@yahoo.es','M','1720524204','La Forestal');
...
INSERT INTO `usuario` VALUES (3,'Admin','1234','Admin',1),(4,'secre','secre','Recepcionista',1),(5,'perico2','1234','Medico',1),(6,'leonardofrancisco3','1234','Medico',1),(7,'juan4','1234','Medico',1);
...
-- Dump completed on 2018-06-04 21:04:56
