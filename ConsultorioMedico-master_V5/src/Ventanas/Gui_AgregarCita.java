...
public class Gui_AgregarCita extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(0, 115, 115));
        setClosable(true);
        setIconifiable(true);
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 30, 230, -1));
...
// TODO add your handling code here:
    ...
    public boolean DiaDisponible() {
        ...
        if (!ckX.isSelected() && Dia == 4) {
            this.jTable1.setEnabled(false);
            jTable1.setDefaultRenderer(Object.class, new MiRenderDisable());
            JOptionPane.showMessageDialog(this, "Dia Miércoles no disponible en horario del medico", "No disponible",
                    JOptionPane.ERROR_MESSAGE);
            return false;
        }
        ...
        if (!ckS.isSelected() && Dia == 7) {
            this.jTable1.setEnabled(false);
            jTable1.setDefaultRenderer(Object.class, new MiRenderDisable());
            JOptionPane.showMessageDialog(this, "Dia Sábado no disponible en horario del medico", "No disponible",
                    JOptionPane.ERROR_MESSAGE);
            return false;
