...
public class AgregarDiagnostico extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(83, 82, -1, -1));

        jLabel7.setFont(new java.awt.Font("Noto Sans", 0, 14)); // NOI18N
        jLabel7.setText("Paciente");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 30, 82, 39));

        txtPaciente.setEditable(false);
        txtPaciente.setDoubleBuffered(true);
        getContentPane().add(txtPaciente, new org.netbeans.lib.awtextra.AbsoluteConstraints(101, 32, 243, 39));

        jLabel10.setFont(new java.awt.Font("Noto Sans", 0, 14)); // NOI18N
        jLabel10.setText("Doctor");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(364, 30, 55, 39));

        txtDr.setEditable(false);
        getContentPane().add(txtDr, new org.netbeans.lib.awtextra.AbsoluteConstraints(431, 32, 243, 39));
